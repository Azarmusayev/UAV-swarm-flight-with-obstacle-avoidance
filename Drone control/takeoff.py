...
def TakeoffLand():
    ...
    # Subcribers
    land_sub = rospy.Subscriber('/ardrone1/cmd_vel/move_base/feedback', MoveBaseActionFeedback, goal_cb) # Information about move_base goal
    cmd_vel_sub = rospy.Subscriber('/ardrone1/cmd_vel', Twist, cmd_vel_cb) # Allows access for current command velocities published
    takeoff_sub = rospy.Subscriber('/ardrone1/ground_truth_to_tf/pose', PoseStamped, takeoff_cb) # Information about pose of the drone
...
def takeoff_cb(msg):
    ...
    global landing, isGoal, twist_msg, ardrone1_cmd_vel_pub, ardrone2_cmd_vel_pub, ardrone3_cmd_vel_pub, ardrone4_cmd_vel_pub, land
